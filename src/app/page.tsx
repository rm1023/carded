...
export default function CreditCardForm() {
  ...
  const getStepIcon = (step: number) => {
    switch (step) {
      case 1: return <CreditCard className="h-5 w-5" />
      case 2: return <Gift className="h-5 w-5" />
      ...
      case 7: return <Info className="h-5 w-5" />
      default: return null
    }
  }
  ...
  return (
    <div className="container mx-auto p-4">
      <header className="text-center mb-6">
        <div className="inline-flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-500 rounded-full p-2 mb-2">
          <CardIcon className="h-6 w-6 text-white" />
        </div>
        <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 mb-1">
          Carded
        </h1>
      ...
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader className="flex flex-row items-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-t-lg py-2">
          {getStepIcon(step)}
          <CardTitle className="text-lg">{getStepDescription(step)}</CardTitle>
        </CardHeader>
        <CardContent>
